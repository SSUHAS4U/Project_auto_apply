...
public class AtsDiscoveryService {
    ...
    private static final String[][] CANDIDATES = {
            ...
            // Widened first-party coverage. Aggregators (Adzuna/Jooble) were removed because
            // they re-publish stale, already-filled listings; the fix for volume is MORE ATS
            // boards, not aggregation. A wrong token here costs one cheap 404 and is dropped.
            ...
            {"greenhouse", "zoho", "Zoho"},
            {"greenhouse", "swiggy", "Swiggy"},
            ...
            {"ashby", "replit", "Replit"},
            {"smartrecruiters", "McDonalds", "McDonald's"},
            {"smartrecruiters", "Ubisoft", "Ubisoft"},
            {"smartrecruiters", "Publicis", "Publicis"},
            {"smartrecruiters", "Avery", "Avery Dennison"},
            {"workable", "deel", "Deel"},
            {"workable", "hotjar", "Hotjar"},
