...
const PATHS: Record<string, JSX.Element> = {
  ...
  eyeOff: <><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c4.2 0 7.8 2.6 9.94 6.65a1 1 0 0 1 0 .7 10.8 10.8 0 0 1-1.44 2.49" /><path d="M14.08 14.16a3 3 0 0 1-4.24-4.24" /><path d="M17.48 17.5A10.75 10.75 0 0 1 2.06 12.35a1 1 0 0 1 0-.7 10.8 10.8 0 0 1 4.45-5.14" /><path d="m2 2 20 20" /></>,
