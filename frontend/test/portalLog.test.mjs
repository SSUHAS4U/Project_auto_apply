// Per-portal log splitting. Run: node --test test/
//
...
// Imported directly: Node strips the type annotations, so the test runs the real module
// rather than a copy of it.
import { filterPortalLog, hasPortalActivity } from '../src/lib/portalLog.ts';
